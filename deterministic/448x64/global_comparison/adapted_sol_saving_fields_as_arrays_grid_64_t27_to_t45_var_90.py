...
data_file ='./fields_as_arrays/u_theta_adapted_sol_arrays_mesh_64_at_t_27.0.npz'
...
while (round(t,4) <= t_end):
    ...
    if iter_n%freq == 0:
        ...
        data_file ='./fields_as_arrays/u_theta_adapted_sol_arrays_mesh_64_at_t_'+str(round(t,4))+'.npz'
