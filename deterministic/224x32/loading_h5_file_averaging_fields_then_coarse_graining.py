...
with CheckpointFile("../1792x256/h5_files/grid_256_fields_at_time_t=27.0.h5", 'r') as afile:
...
outfile2 = File("./results/coarse_grained_fields_t=45.pvd")
...
# h5_file = "./h5_files/coarse_grained_vel_temp_at_t=27.0_mesh_32_c_1_by_32.h5"
