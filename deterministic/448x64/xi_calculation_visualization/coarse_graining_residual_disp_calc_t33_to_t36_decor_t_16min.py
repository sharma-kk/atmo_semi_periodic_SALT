...
Dt_uc = 0.02 # assumed decorrelated time (same as Dt)
t_start = 33
t_end = 36
...
for i in t_stamps:
    ...
    data_file_1 = './data_for_xi_calculation/dX_data_t='+str(t_start)+'_to_t='+str(t_end)+'_grid_64_c=1by64_decor_t_16min.npz'
    ...
    if round(i - int(i), 2) == 0:
        ...
        data_file_2 = '../data_from_deterministic_run/coarse_grained_vel_temp_vort_data_t='+str(t_start)+'_to_t='+str(t_end)+'_grid_64_c=1by64_decor_t_16min.npz'
