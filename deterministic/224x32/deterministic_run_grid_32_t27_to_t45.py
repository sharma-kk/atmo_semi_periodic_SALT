...
data_file_1 = './data_from_deterministic_run/coarse_grid_sim_vel_temp_vort_data_t=27_to_t=45_coarse_grained_ic.npz'
...
outfile = File("./results/deterministic_run_grid_32_t27_to_t45.pvd")
...
data_file_2 = "./KE_details/deterministic_run_grid_32_t27_to_t45.txt"
