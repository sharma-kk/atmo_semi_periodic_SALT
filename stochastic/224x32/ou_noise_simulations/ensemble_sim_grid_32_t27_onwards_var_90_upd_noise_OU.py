...
if ensemble_comm.rank%pvd_print == 0: # printing results correponding to every pvd_print particle
    ...
    outfile = File('../results/OU_sim_var_90_mesh_32_particle_'+str(ensemble_comm.rank)+'_t27_onwards.pvd', comm = spatial_comm)
...
while (round(t,4) <= t_end):
    ...
    if iter_n%freq == 0:
        ...
        data_file = '../data_from_stochastic_run/vel_temp_vort_data_particle_'+str(seed_no)+'_var_90_grid_32_t27_onwards_upd_noise_OU.npz'
