...
seed_no = ensemble_comm.rank + 1 # unique seed no. is assigned to each ensemble member. The ensemble starts from particle no. 1 onwards.
...
# the OU_mat function has been updated to take acf1_data of any size. See the utilities.py script !
...
while (round(t,4) <= t_end):
    ...
    if iter_n%freq == 0:
        ...
        data_file = '../../data_from_stochastic_run/vel_temp_vort_data_particle_'+str(seed_no)+'_var_50_grid_32_t27_onwards_upd_noise_OU.npz'
