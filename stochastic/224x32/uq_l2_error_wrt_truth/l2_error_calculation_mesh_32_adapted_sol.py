...
u_ad = Function(V1) ; theta_ad = Function(V2)  # deterministic solution
...
l2_vel_ada_v_truth_global = [] # relative l2 error between deterministic and coarse grained truth  
