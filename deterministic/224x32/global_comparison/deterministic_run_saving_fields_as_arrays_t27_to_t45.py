...
data_file ='./coarse_grained_fields_data/u_theta_deter_sim_arrays_mesh_32_at_t_27.0.npz'
...
while (round(t,4) <= t_end):
    ...
    if iter_n%freq == 0:
        ...
        data_file ='./coarse_grained_fields_data/u_theta_deter_sim_arrays_mesh_32_at_t_'+str(round(t,4))+'.npz'
