...
n_EOF = 18 # desired no. of EOFs to include in stochastic sim
##############
# 94 EOFs ---------> 90 % variance
# 39 EOFs ---------> 70 % variance
# 18 EOFs ---------> 50 % variance 
...
while (round(t,4) <= t_end):
    ...
    if iter_n%freq == 0:
        ...
        data_file = '../data_from_stochastic_run/vel_temp_vort_data_particle_'+str(seed_no)+'_var_50_grid_64_t27_onwards_OU.npz'
