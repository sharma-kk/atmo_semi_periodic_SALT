...
outfile = File("./results/adaptive_ref_sol_grid_32_t27_to_t45.pvd")
...
data_file_2 = "./KE_details/adaptive_ref_sol_grid_32_t27_to_t45.txt"
...
while (round(t,4) <= t_end):
    ...
    if iter_n%freq == 0:
        ...
        data_file_1 = './data_from_deterministic_run/adaptive_sol_mesh_32_sim_vel_temp_data_t=27_to_t=45_coarse_grained_ic.npz'
        np.savez(data_file_1, gridpoints = gridpoints, vel_data = np.array(vel_data), temp_data= np.array(temp_data))
