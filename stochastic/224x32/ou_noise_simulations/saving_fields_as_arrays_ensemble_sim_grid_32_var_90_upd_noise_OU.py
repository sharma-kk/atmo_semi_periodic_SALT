...
data_file = '../ensemble_vel_temp_data_as_arrays/OU_sim_var_90_mesh_32_particle_'+str(seed_no)+'fields_data_at_t_27.0.npz'
...
while (round(t,4) <= t_end):
    ...
    if iter_n%freq == 0:
        ...
        data_file = '../ensemble_vel_temp_data_as_arrays/OU_sim_var_90_mesh_32_particle_'+str(seed_no)+'fields_data_at_t_'+str(round(t,4))+'.npz'
